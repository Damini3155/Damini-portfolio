  ...
  return (
    <>
      ...
      <main className="pt-20 min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 text-white font-sans scroll-smooth">
        ...
        {/* soft skills */}
        <section class="py-16 px-6 text-center bg-gray-900"><h2 class="text-3xl font-bold mb-10 text-cyan-300">🧠 Soft Skills</h2><div class="max-w-5xl mx-auto grid grid-cols-2 sm:grid-cols-4 gap-8"><div class="relative w-32 h-32 mx-auto"><svg class="absolute top-0 left-0 w-full h-full transform rotate-[-90deg]"><circle cx="50%" cy="50%" r="45%" stroke="#2d3748" stroke-width="10" fill="none"></circle><circle cx="50%" cy="50%" r="45%" stroke="#06b6d4" stroke-width="10" fill="none" stroke-dasharray="282.6" stroke-dashoffset="28.3" stroke-linecap="round"></circle></svg><div class="absolute inset-0 flex flex-col items-center justify-center text-white"><span class="text-xl font-bold">90%</span><span class="text-xs mt-1">COLLABORATION</span></div></div><div class="relative w-32 h-32 mx-auto"><svg class="absolute top-0 left-0 w-full h-full transform rotate-[-90deg]"><circle cx="50%" cy="50%" r="45%" stroke="#2d3748" stroke-width="10" fill="none"></circle><circle cx="50%" cy="50%" r="45%" stroke="#06b6d4" stroke-width="10" fill="none" stroke-dasharray="282.6" stroke-dashoffset="42.4" stroke-linecap="round"></circle></svg><div class="absolute inset-0 flex flex-col items-center justify-center text-white"><span class="text-xl font-bold">85%</span><span class="text-xs mt-1">INNOVATIVE IDEAS</span></div></div><div class="relative w-32 h-32 mx-auto"><svg class="absolute top-0 left-0 w-full h-full transform rotate-[-90deg]"><circle cx="50%" cy="50%" r="45%" stroke="#2d3748" stroke-width="10" fill="none"></circle><circle cx="50%" cy="50%" r="45%" stroke="#06b6d4" stroke-width="10" fill="none" stroke-dasharray="282.6" stroke-dashoffset="56.5" stroke-linecap="round"></circle></svg><div class="absolute inset-0 flex flex-col items-center justify-center text-white"><span class="text-xl font-bold">80%</span><span class="text-xs mt-1">COLLABORATION</span></div></div><div class="relative w-32 h-32 mx-auto"><svg class="absolute top-0 left-0 w-full h-full transform rotate-[-90deg]"><circle cx="50%" cy="50%" r="45%" stroke="#2d3748" stroke-width="10" fill="none"></circle><circle cx="50%" cy="50%" r="45%" stroke="#06b6d4" stroke-width="10" fill="none" stroke-dasharray="282.6" stroke-dashoffset="28.3" stroke-linecap="round"></circle></svg><div class="absolute inset-0 flex flex-col items-center justify-center text-white"><span class="text-xl font-bold">90%</span><span class="text-xs mt-1">Problem Solving</span></div></div></div></section>
